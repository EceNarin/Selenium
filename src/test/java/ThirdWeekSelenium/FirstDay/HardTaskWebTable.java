...
public class HardTaskWebTable extends TestBase {
    ...
    public void test(){
        ...
        boolean empty=driver.findElements(By.xpath("/html/body/div[1]/div[3]/div/div[2]/main/div/div[1]/div/article/div/div/div[3]/div[1]/div[4]/table/tbody/tr/td[6]")).stream().allMatch(t->t.getText().length()==0);;
    ...
    private void oldestStructer() {
        ...
        List<WebElement> oldestStructures=driver.findElements(By.xpath("//*[@id=\"post-body-5867683659713562481\"]/div[1]/div[4]/table/tbody/tr/td[4]"));
        ...
        List<WebElement> allStructures=driver.findElements(By.xpath("//*[@id=\"post-body-5867683659713562481\"]/div[1]/div[4]/table/tbody/tr"));
    ...
    private void structercInform() {
        ...
        System.out.println("Tablodaki yapilarin sayisi : " + driver.findElements(By.xpath("//*[@id=\"post-body-5867683659713562481\"]/div[1]/div[4]/table/tbody/tr")).size());
        System.out.println("tablodaki yapilarin isimleri");
        driver.findElements(By.xpath("//*[@id=\"post-body-5867683659713562481\"]/div[1]/div[4]/table/tbody//th")).stream().forEach(t-> System.out.println(t.getText()));
        //5. Tablonun son satırının sadece 2 kolon içerdiğini doğrula
        //6. Tabloda yapı satırlarının kaç kolon içerdiğini yazdır
        int structuresFields=driver.findElements(By.xpath("//*[@id=\"post-body-5867683659713562481\"]/div[1]/div[4]/table/thead/tr/th")).size();
        System.out.println("Structures fields are : " + structuresFields );
        //9. Yapıların isim listesini başlığıyla birlikte yazdır
        driver.findElements(By.xpath("//*[@id=\"post-body-5867683659713562481\"]/div[1]/div[4]/table/tbody/tr/th")).stream().forEach(t-> System.out.println(t.getText() + "  "));
    }
    private void highestFunction() {
        //3. En uzun yapının bilgilerini yazdır
        ...
        int highest= highStructures.stream().mapToInt(t-> Integer.parseInt(t.getText().replaceAll("[^0-9]",""))).min().getAsInt();
